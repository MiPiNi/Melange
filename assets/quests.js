const questsTab = [
	...
	"Musisz zrobić wszystko co osoba po Twojej prawie Ci rozkaże. Jeśli odmówisz pijesz",
	...
	"Możesz wymyślić zasadę którą reszta graczy będzie musiała przestrzegać, chyba że wolą się napić",
	"Każdy musi zatańczyć jakiś głupi taniec jeśli nie to pijecie",
	"Klepnij gracza w dupsko po Twojej lewej",
	"Wybierz osobę która ma najpiękniejsze oczy. Musi się napić",
	"Nie możesz mówić po Polsku przez następną rundę",
	"Zadzwoń do kogoś i powiedz że ją kochasz (byle nie do matki)",
	"Ćpuny piją",
	...
	"Wymień dziesięć słów na literę 'P'",
	"Posiadacze kotów piją.",
	"Posiadacze psów piją.",
	"Opowiedz o najdziwniejszym porno jakie oglądałeś",
	...
	"Możesz wymyślić zasadę którą reszta graczy będzie musiała przestrzegać",
